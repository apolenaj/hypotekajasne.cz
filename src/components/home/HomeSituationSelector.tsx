...
const SITUATIONS = [
  ...
  },
  {
    ...
    hint: "Sazby a podmínky pro refinancování",
  },
  {
    id: "investment",
    ...
    hint: "Investiční rentgen a modelace",
  },
  {
    id: "osvc",
    situation: "osvc",
    ...
    hint: "Orientační možnosti podle situace",
  },
  {
    id: "foreign",
    ...
    hint: "Co typicky řeší banky u zahraničního příjmu",
  },
  {
    id: "american",
    situation: "american",
    label: "Americká hypotéka",
    href: `${routes.sazby}?purpose=purchase&note=american`,
    hint: "Zveřejněné sazby a další postup",
  },
] as const;
