...
const kbConditionalAdvertised: ImportRateRecord = {
  ...
  auditStatus: "IMPORT_READY",
  notes:
    "Product-page conditional od 5,49% (re-verified 2026-09-21). Fixation and LTV not stated on headline — must not personalized-match LTV or replace Oznámení matrix.",
};
...
export const CZ_2026_08_09_EXAMPLES: ImportRepresentativeExample[] = [
  ...
  },
  {
    ...
    fixationMonths: 36,
    nominalRate: 5.49,
    monthlyPayment: 22_712,
    rpsn: 5.65,
    totalAmountPayable: 8_169_872.14,
