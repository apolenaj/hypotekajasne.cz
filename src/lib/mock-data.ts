...
export const footerLinks = {
  ...
  investice: [
    ...
    { href: routes.investicniRentgenUkazka, label: "Ukázka Rentgenu" },
    { href: getLandingPath("investicni-hypoteka"), label: "Investiční hypotéka" },
    { href: routes.kalkulacky.potencialniVyvoj, label: "Potenciální vývoj" },
    { href: routes.kalkulacky.budouciPrijemZNajmu, label: "Příjem z nájmu" },
  ],
  zahranici: [
    ...
    { href: getLandingPath("hypoteka-ze-zahranicniho-prijmu"), label: "Zahraniční příjem" },
  ],
  nastroje: [
    { href: routes.kalkulacky.hypotecniKalkulacka, label: "Hypoteční kalkulačka" },
    { href: routes.kalkulacky.koupeVsNajem, label: "Koupě vs. nájem" },
    { href: routes.kalkulacky.rodinnyRozpocet, label: "Rodinný rozpočet" },
    { href: routes.sazby, label: "Sazby hypoték" },
